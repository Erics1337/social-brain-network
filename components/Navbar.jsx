...
function Navbar() {
  ...
  return <div className="shadow-md border-b bg-white sticky top-0 z-50">
        ...
        /* Middle Part - Custom search input field */
                ...
                <div className='max-w-xs '>
                    <div className='relative mt-1 p-3 rounded-md'>
                        ...
                        <input className="bg-grey-50 block w-full pl-10 sm:text-sm border-grey-300 focus:ring-black focus:border-black rounded-md border-grey-300" type="text" placeholder="Search" />
                    </div>
                </div>
